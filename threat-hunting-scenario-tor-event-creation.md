...
6. Create a folder on your desktop called ```torshoplist.txt``` and put a few fake (illicit) items in there
7. Delete the file.
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `March 6, 2024`  | `Prinxe Nadana`   
